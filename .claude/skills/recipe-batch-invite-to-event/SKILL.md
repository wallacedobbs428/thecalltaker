...
version: 1.0.0
description: "Add a list of attendees to an existing Google Calendar event with notifications. Use when bulk-inviting people to a meeting or adding attendees to events."
metadata:
  openclaw:
    category: "recipe"
    domain: "scheduling"
