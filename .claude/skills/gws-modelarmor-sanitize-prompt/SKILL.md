...
version: 1.0.0
description: "Google Model Armor: Sanitize a user prompt through a safety template. Use when filtering user input for safety, content policy compliance, or prompt injection detection."
metadata:
  openclaw:
    category: "security"
    requires:
