...
description: "MUST be used for Vue.js tasks. Use when writing Vue 3 code, working with .vue files, Composition API, Pinia, or Vue Router. Strongly recommends script setup + TypeScript."
license: MIT
metadata:
