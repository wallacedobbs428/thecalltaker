...
version: 1.0.0
description: "Google Workflow: Convert a Gmail message into a Google Tasks entry. Use when turning emails into actionable tasks or creating todos from inbox messages."
metadata:
  openclaw:
