# The Call Taker — Cold DM Scripts (Instagram, Facebook, LinkedIn)
...
## DM 1: The Secret Shopper Opener (Best Performer)
...
## DM 2: The Straight Value Drop

Use this when you haven't secret-shopped them yet.
...
**Why it works:** Leads with a question (gets engagement), then offers a no-commitment way to experience the product.
...
**Why it works:** Creates urgency and FOMO without being pushy.

---

## DM 4: The Pain Point

Use when their profile or posts show they're busy/growing fast.

> [First Name] — saw you guys are crushing it. Serious respect.
>
> Quick thought: when you're on a job and the phone rings, what happens? If it goes to voicemail, 85% of those people just call the next guy.
>
> I built something that fixes that. AI picks up in 2 seconds, books the job, texts you everything. Want to see it?

**Why it works:** Compliment + pain point + solution in one message. Works great for owners who clearly take pride in their business.
...
**Why it works:** Low pressure, gives them a way to try it without talking to you first.
...
**Why it works:** You've already engaged publicly (so you're not a total stranger), then the DM feels natural.
...
**Weekly goal:** 50 DMs sent, 5 demo calls completed, 1 paying client
...
6. **Don't message the same person on multiple platforms.** Pick one and stick with it.
7. **Profile matters.** Make sure your Instagram/Facebook shows The Call Taker branding, website link, and looks professional.
