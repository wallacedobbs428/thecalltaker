...
(function() {
  ...
  css.textContent = [
    ...
    '.cp-item:hover,.cp-item.active{background:rgba(234,88,12,.06)}',
    '.cp-item.active{outline:2px solid rgba(234,88,12,.3);outline-offset:-2px}',
    ...
    '.cp-icon-action{background:rgba(234,88,12,.08);color:#ea580c}',
