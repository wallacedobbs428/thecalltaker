# THE CALL TAKER — Morning Battle Plan
...
> **This is the #1 money move. Every voicemail you find is a potential $297/mo client.**
...
| Metric | Goal |
|--------|------|
| Secret shopper calls | 10-15 |
| Voicemails found | 5+ |
| Cold emails sent | 5+ |
| ColdDMs replies handled | All of them |
| Demos booked | 1 (stretch goal) |
...
| Secret shopper tracker | `sales/secret-shopper-template.md` |
| Cold email scripts | `sales/cold-email-sequence.md` |
| Cold call script | `sales/cold-call-script.md` |
| Demo walkthrough | `sales/demo-script.md` |
| One-page proposal | `sales/one-page-proposal.md` |

---

*Every missed call is a missed job. Today you start fixing that for HVAC companies — and getting paid for it.*
