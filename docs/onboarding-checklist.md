...
> Goal: Gideon live on their phones before you hang up.
...
- [ ] Go-live goal: "Gideon is answering your phones tonight"
...
- [ ] Services offered (list the job types Gideon should book)
...
- iPhone: Settings → Phone → Call Forwarding → ON → enter Gideon's number
- Android: Phone app → Settings → Call Forwarding → When unanswered → enter Gideon's number
- "Turn this on when you leave the office, off when you open"

**Option B — Full 24/7 forwarding (Pro plan)**
- Call carrier: "Forward all calls from [business number] to [Gideon number]"
- Or use legacy CRM's built-in number with porting
...
- [ ] Test the forward: call their business number, confirm Gideon answers
- [ ] If forwarding fails, troubleshoot carrier settings or schedule follow-up

### 5. Book Future Calls
- [ ] Day 7 tuning call: "I'll call you [day] at [time] to review how Gideon's doing — 15 minutes"
- [ ] Day 30 value review: "And one more at the 30-day mark to show you the full report"
- [ ] Add both to YOUR calendar with reminders

### 6. End the Call
- [ ] Restate: "So Gideon goes live tonight. I'm doing 3 test calls in the next hour. You'll get a text when she's ready. Day 7 we tune, Day 30 we review. Sound right?"
...
### 7. Configure Gideon in legacy CRM
- [ ] Create/update contact in legacy CRM with tags: `new-customer`, `in-trial`, `[plan]-plan`, `[vertical]`
- [ ] Set up Gideon's greeting: "Thanks for calling [Business Name], this is Gideon, how can I help you?"
...
- [ ] Send ntfy confirmation: "LIVE: [business name] — Gideon active on [phone number]"

### 10. Document
- [ ] Log in `ops/call-tracker.csv`: outcome = Trial Started
- [ ] Note in legacy CRM contact: plan, vertical, forwarding type, booking tool, any special rules
