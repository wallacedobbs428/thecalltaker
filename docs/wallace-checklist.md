# Wallace's Manual Checklist
**Only things that need YOUR hands, passwords, credit card, or physical presence.**
...
☑ Set your availability hours
  ...
  3. Set your available hours (e.g., Mon-Fri 9am-5pm)
  4. Set your timezone
  5. Connect your personal Google Calendar so it checks for conflicts
...
☑ Set up Conversation AI in GHL
  ...
  5. Assign it to the phone number +16156539004
  6. Test by calling the number yourself
...
☐ Paste email content into GHL templates
  ...
  3. Style them with your brand colors (navy, blue, orange)
  4. Save each one
...
☐ Call 20+ local HVAC companies after 6pm
  📍 Where: Your phone
  ⏱ Time: 1-2 hours over a few evenings
...
☐ Walk a prospect through the AI in action
  📍 Where: Phone/Zoom
...
☐ Sign agreement, collect payment, set them up
  ...
  Steps:
  1. Send the client agreement from onboarding/client-agreement-template.md
  2. Collect payment via Stripe
  3. Send intake form from onboarding/new-client-intake-form.md
  4. Follow onboarding-steps.md to set them up
  5. Welcome email sequence starts automatically
...
☐ Replace placeholder testimonials with real ones
  📍 Where: Send quotes to your developer to update the website
  ⏱ Time: 5 minutes
  💡 Why: Real testimonials convert better than placeholders
  🔑 What you need: Quotes from happy clients

### 11. Set Up Social Media
☐ Create business profiles
  📍 Where: Instagram, Facebook, Google Business
  ⏱ Time: 30 minutes each
  💡 Why: Online presence builds trust
  🔑 What you need: Business info, logo, photos

### 12. Add Real Photos to Website
☐ Get a professional headshot and action photos
  📍 Where: Local photographer or good phone camera
  ⏱ Time: 1 hour
  💡 Why: Real photos build trust — placeholder initials don't
  🔑 What you need: Camera/photographer
